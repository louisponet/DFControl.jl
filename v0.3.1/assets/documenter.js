...
requirejs.config({
  paths: {
    'highlight-julia': 'https://cdnjs.cloudflare.com/ajax/libs/highlight.js/10.3.1/languages/julia.min',
    ...
    'highlight': 'https://cdnjs.cloudflare.com/ajax/libs/highlight.js/10.3.1/highlight.min',
    'highlight-julia-repl': 'https://cdnjs.cloudflare.com/ajax/libs/highlight.js/10.3.1/languages/julia-repl.min',
  },
  shim: {
  "highlight-julia": {
    "deps": [
