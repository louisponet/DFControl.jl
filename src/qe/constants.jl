...
const QEInputInfos = QEInputInfo[]
function init_QEInputInfos()
    ...
    append!(QEInputInfos, vcat(QEInputInfo.(filepaths), QEInputInfo("pw2wannier90.x", [pw2wannier90_block_info], QEDataBlockInfo[])))
end
