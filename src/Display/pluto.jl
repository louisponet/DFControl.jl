...
display(io::IO,  v::InputData) = df_display(io, v)

display(io::IO,  v::Band) = df_display(io, v)

display(io::IO,  v::Job) = df_display(io, v)
display(io::IO,  v::Calculation) = df_display(io, v)
display(io::IO,  v::Calculations.QEFlagInfo) = df_display(io, v)
display(io::IO,  v::Calculations.ElkFlagInfo) = df_display(io, v)
display(io::IO,  v::Calculations.ElkControlBlockInfo) = df_display(io, v)
display(io::IO,  v::Element) = df_display(io, v)
display(io::IO,  v::Structure) = df_display(io, v)
display(io::IO,  v::Atom) = df_display(io, v)
display(io::IO,  v::Projection) = df_display(io, v)
