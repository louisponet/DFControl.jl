...
setdefault_pseudo_dir(:sssp, "~/pseudos/sssp")
setdefault_pseudo_dir(:pbesol, "~/pseudos/pbesol/PSEUDOPOTENTIALS")
setdefault_pseudo_dir(:pbesolrel, "~/pseudos/pbesolrel/PSEUDOPOTENTIALS")
