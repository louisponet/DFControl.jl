...
test_bands = read_qe_bands_file(joinpath(@__DIR__, "testassets/test_job/nscf.out"))
...
t_fermi = read_fermi_from_qe_output(joinpath(@__DIR__,"testassets/test_job/nscf.out"))
