...
using Plots
test_bands = QuantumEspresso.read_qe_bands_file(joinpath(@__DIR__, "testassets", "test_job", "nscf.out"))
...
t_fermi = QuantumEspresso.read_fermi_from_qe_output(joinpath(@__DIR__, "testassets", "test_job", "nscf.out"))
